...
set +e                      - не прерывать скрипт после выполнения команды с ошибкой
```
...
строка1 =~ регулярное_выражение	        возвращающее истинное значение, если строка1 соответствует расширенному регулярному выражению [[]]
```
